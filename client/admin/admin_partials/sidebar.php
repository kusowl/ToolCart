      ...
      <ul class="space-y-2">
          ...
          <li>
              ...
              <ul id="dropdown-product-pages" class="hidden py-2 space-y-2">
                  ...
                  <li>
                      <a href="category_table.php" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">View All Products</a>
                  </li>
              </ul>
          </li>
      </ul>
