...
$table_heads = ['Order ID', 'User', 'Amount', 'Delivery Status', 'Payment Type', 'Payment Status','Date'];
$orders = (new Orders())->getAllOrders(99);
$table_records = [];
$records = [];
foreach ($orders as $ordersRec) {
    ...
    $records['delivery_status'] = $ordersRec->getDeliveryStatus();
    $records['payment_type'] = $ordersRec->getPaymentType();
    $records['payment_status'] = $ordersRec->getPaymentStatus() ?: 'Pending' ;
