                    ...
                    if (!empty($cartRecords)):
                        ...
                        <div class="space-y-6">
                            ...
                            foreach ($cartRecords as $record):
                                ...
                                $originalPrice += (int)$record['qty'] * (int)$record['product_price'];
                                ?>
                                    ...
                                    <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        ...
                                        <div class="flex items-center justify-between md:order-3 md:justify-end">
                                            <div class="flex items-center">
                                                <button type="button" data-product-id="<?= $record['product_id'] ?>"
                                                        class="decrementCartBtn inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                ...
                                                <button
                                                        ...
                                                        class="incrementCartBtn inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-2.5 w-2.5 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                            ...
                                            <div class="flex items-center gap-4">
                                                ...
                                                <button type="button"
                                                        class="removeCartItemBtn inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500"
                                                        data-product-id="<?= $record['product_id'] ?>">
                                                    <svg class="me-1.5 h-5 w-5" aria-hidden="true"
                                                         xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         fill="none" viewBox="0 0 24 24">
